# Script to organise data of genome elimination project
# From raw data to organised and renamed data

#Extract raw data in a new directory
cd data
mv "Projet_62_21/Fastq files/" fastq_files/

#Rename data in the new directory
cd data/fastq_files
