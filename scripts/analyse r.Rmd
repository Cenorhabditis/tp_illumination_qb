...
significatif_down <- subset(res_df, log2FoldChange < 0 & baseMean > 10 & padj < 0.00000005)
significatif_down

plot_counts(significatif_down$gene_ID[1:40])
plot_counts(significatif_down$gene_ID[41:55])
